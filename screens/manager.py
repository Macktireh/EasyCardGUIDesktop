...
class ScreenManager(CTkFrame):
    ...
    def initializeScreens(self) -> None:
        self.dashboardScreen = DashboardScreen(self, chartService=MatplotlibService(plt, **rcParams(self._get_appearance_mode())))
    ...
    def checkAuthentication(self) -> bool:
        ...
        def _checkAuthentication(self: ScreenManager):
            ...
            if response.status_code == HTTPStatus.UNAUTHORIZED:
                self.modal.show(text="Oops, we have an authentication problem.\n Please reload the application and try again.")
                self.toast.show(
